...
from keras.src.layers import Embedding, LSTM, Dense, Dropout, Bidirectional, BatchNormalization
...
def generate_lstm_answer(question,model):
    with open('model_and_weight/tokenizer_LSTM_2000.pickle', 'rb') as handle:
